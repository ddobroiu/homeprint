...
- **Contact**: Telefon 0750.473.111, Email contact@HomePrint.ro.
...
export const tools: OpenAI.Chat.Completions.ChatCompletionTool[] = [
  ...
  },
  {
    ...
    function: {
      name: "generate_offer",
      description: "GenereazÄƒ un PDF profesional cu oferta de preÈ› (proformÄƒ) pentru produsele discutate. PDF-ul include logo HomePrint.ro, detalii furnizor/beneficiar, tabel produse, È™i total. ReturneazÄƒ link cÄƒtre PDF pentru descÄƒrcare.",
      parameters: {
        type: "object",
        properties: {
          customer_details: {
...
EÈ™ti asistentul virtual HomePrint.ro. RÄƒspunde RAPID È™i CONCIS. Pune Ã®ntrebÄƒri SCURTE, cÃ¢te una pe rÃ¢nd.
...
- Header cu logo HomePrint.RO
- Detalii furnizor (HomePrint.ro, contact@HomePrint.ro, 0750.473.111)
- Detalii beneficiar (nume, adresÄƒ, email, telefon)
- Tabel cu produse (nume, cantitate, preÈ› unitar, total)
- Total general
- Validitate ofertÄƒ (30 zile)
- MenÈ›iune "Generat automat de asistentul HomePrint.ro"
...
"Pentru detalii specifice sau nelÄƒmuriri, ne puteÈ›i contacta la telefon **0750.473.111** sau pe email la **contact@HomePrint.ro**."
