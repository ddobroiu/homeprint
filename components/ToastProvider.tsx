...
function ToastItem({ toast, onRemove }: { toast: Toast; onRemove: (id: string) => void }) {
    const icons = {
        success: <div className="bg-amber-100 p-1.5 rounded-full"><CheckCircle className="w-5 h-5 text-amber-600" /></div>,
        ...
        info: <div className="bg-amber-100 p-1.5 rounded-full"><Info className="w-5 h-5 text-amber-600" /></div>,
    };
