...
export default function AccountOrderCard({ order }: AccountOrderCardProps) {
    ...
    return (
        <li className="p-4 sm:p-6 rounded-xl border-2 border-gray-200 bg-white hover:shadow-lg transition-all duration-200 hover:border-amber-400">
                ...
                <div className="mb-4 p-3 bg-amber-50 border border-amber-200 rounded-lg flex items-center justify-between">
                    ...
                    {awbUrl && (
                        <a
                            ...
                            className="text-xs font-bold bg-amber-600 text-white px-3 py-1 rounded hover:bg-amber-700 transition-colors"
                        >
                            Track →
                        </a>
                    )}
            ...
            <div className="flex flex-wrap gap-2 pt-4 border-t border-gray-200">
                <Link
                    ...
                    className="inline-flex items-center justify-center gap-2 rounded-lg bg-amber-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-amber-700 transition-colors flex-1 sm:flex-none"
                >
