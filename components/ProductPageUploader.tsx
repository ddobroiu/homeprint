      ...
      {!fileName ? (
        ...
        <div className="flex items-center justify-between p-3 bg-amber-50 border border-amber-200 rounded-xl">
            <div className="flex items-center gap-2 overflow-hidden">
                ...
                <span className="text-sm text-amber-700 truncate font-medium">{fileName}</span>
            </div>
            <button onClick={clearFile} className="p-1 hover:bg-amber-100 rounded-full text-amber-600 transition-colors">
                <X size={16} />
            </button>
        </div>
      )}
