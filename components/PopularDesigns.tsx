        ...
        <section className="w-full bg-gradient-to-br from-slate-50 to-white py-12 border-t border-slate-200 mt-12 overflow-hidden">
            <div className="container mx-auto px-4">
                ...
                <div className="flex items-center justify-between mb-8">
                    <div>
                        <h2 className="text-2xl font-bold text-slate-900 flex items-center gap-2">
                            <span className="w-1 h-6 bg-amber-600 rounded-full inline-block"></span>
                            {title}
                        </h2>
                ...
                >
                    {displayProducts.map((product) => (
                        ...
                        >
                            ...
                            <div className="p-4">
                                <h3 className="text-sm font-bold text-slate-900 mb-1 leading-tight group-hover:text-amber-600 transition-colors line-clamp-2 min-h-[2.5em]">
                                    {product.title}
                                </h3>
                ...
                <div className="mt-6 text-center sm:hidden">
                    <Link href="/shop/bannere" className="text-amber-600 font-bold text-sm flex items-center justify-center gap-1">
