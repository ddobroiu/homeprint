                        ...
                        >
                            ...
                            <div className="flex-1 min-w-0">
                                <div className="flex items-center gap-2 mb-1">
                                    <span className="shrink-0 inline-flex items-center justify-center h-6 min-w-6 px-1.5 rounded bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-300 text-xs font-bold">
                                ...
                                <div className="relative">
                                    ...
                                    {artworkUrl ? (
                                        ...
                                        <div className="flex flex-col gap-1">
                                            <label
                                                htmlFor={`upload-${item.id}`}
                                                className="cursor-pointer w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2 bg-amber-600 hover:bg-amber-700 text-white shadow-sm rounded-md text-sm font-medium transition-colors"
                                            >
                                                {uploadingId === item.id ? (
                                                    <>
