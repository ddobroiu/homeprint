...
const productFaqs: QA[] = [
    ...
    { question: "Cât durează execuția?", answer: "Pentru cărțile din carton standard/premium 2-4 zile lucrătoare. Pentru materiale speciale (plastic translucid, lemn, metalic) timpul de producție este de 2-4 zile lucrătoare." }
];
