...
export default function CategorySeoContent({ kind }: { kind: string }) {
  ...
  switch (k) {
    case "banner":
      return (
        <div className="space-y-6">
          <h2 className="text-3xl font-black text-white uppercase tracking-tighter italic border-b-2 border-green-500 pb-3 inline-block">Bannere publicitare Frontlit</h2>
          <p className="text-slate-400 text-lg leading-relaxed font-medium italic">Bannerele sunt vizibile, durabile și eficiente pentru exterior. Pentru față simplă recomandăm PVC Frontlit 510 g, iar pentru print pe ambele fețe – material Blockout (opac).</p>
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 text-slate-500 text-sm font-bold uppercase tracking-widest italic">
            <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-green-500 rounded-full"></div> Rezoluție recomandată: 100–150 dpi</li>
            <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-green-500 rounded-full"></div> Finisaje: tiv, capse, buzunare gratuite</li>
            <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-green-500 rounded-full"></div> Montaj rapid cu bride sau sfoară</li>
            <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-green-500 rounded-full"></div> Rezistență UV sporită (3-5 ani)</li>
          </ul>
        </div>
      );
    case "banner-verso":
      return (
        <div className="space-y-6">
          <h2 className="text-3xl font-black text-white uppercase tracking-tighter italic border-b-2 border-green-500 pb-3 inline-block">Banner față–verso</h2>
          <p className="text-slate-400 text-lg leading-relaxed font-medium italic">Material opac (Blockout) pentru print pe ambele fețe, ideal pentru suspendare în spații deschise sau galerii comerciale.</p>
          <div className="pt-4">
            <a className="inline-flex items-center gap-2 text-green-500 font-black uppercase tracking-widest text-xs hover:text-white transition-colors italic border-b border-green-500/30 pb-1" href="/banner-verso">Configurări Face-Verso →</a>
          </div>
        </div>
      );
    case "autocolante":
    ...
    case "alucobond":
      return (
        <div className="space-y-6">
          <h2 className="text-3xl font-black text-white uppercase tracking-tighter italic border-b-2 border-green-500 pb-3 inline-block">Panouri Alucobond</h2>
          <p className="text-slate-400 text-lg leading-relaxed font-medium italic">Placă compozită cu fețe din aluminiu și miez PE, stabilă dimensional și rezistentă la intemperii. Ideală pentru firme, panotaj durabil și proiecte premium.</p>
          <div className="pt-4">
            <a className="inline-flex items-center gap-2 text-green-500 font-black uppercase tracking-widest text-xs hover:text-white transition-colors italic border-b border-green-500/30 pb-1" href="/alucobond">Comandă alucobond online →</a>
          </div>
        </div>
      );
    default:
