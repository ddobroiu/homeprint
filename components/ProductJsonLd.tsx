...
export default function ProductJsonLd({
    ...
    // Only use real rating data explicitly passed by the caller - never fabricate.
    const finalRatingValue = ratingValue;
    ...
    if (finalRatingValue && finalReviewCount && finalReviewCount > 0) {
