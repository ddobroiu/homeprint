                    ...
                    <div className="border-t border-slate-200 pt-3">
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          className={`flex-1 py-2 px-3 rounded-lg border text-sm font-semibold transition-colors ${designOption === 'upload' ? 'bg-amber-600 text-white border-amber-600' : 'bg-white border-gray-300 text-gray-700 dark:text-gray-300 hover:bg-slate-50 dark:bg-slate-800'}`}
                        >
                          Încărcare Fișier
                        </button>
                        <button
                          onClick={() => setDesignOption("pro")}
                          className={`flex-1 py-2 px-3 rounded-lg border text-sm font-semibold transition-colors ${designOption === 'pro' ? 'bg-amber-600 text-white border-amber-600' : 'bg-white border-gray-300 text-gray-700 dark:text-gray-300 hover:bg-slate-50 dark:bg-slate-800'}`}
                        >
                          Vreau Grafică
                        </button>
                      </div>
