        ...
        <main className="bg-slate-50 dark:bg-slate-800 min-h-screen">
                        ...
                        <div className="bg-white rounded-2xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] border border-gray-200 dark:border-slate-800 overflow-hidden">
                            ...
                            <div className="flex border-b border-gray-100 overflow-x-auto">
                                ...
                                <button
                                    ...
                                    className={`flex-1 py-3 min-w-20 text-sm font-medium flex items-center justify-center gap-2 transition-colors ${viewMode === '3d' ? 'text-amber-600 bg-amber-50 border-b-2 border-amber-600' : 'text-gray-500 hover:bg-slate-50 dark:bg-slate-800'}`}
                                >
                            ...
                            <div className="aspect-square relative bg-white">
                                {viewMode === 'gallery' ? (
                                    ...
                                    <div className="w-full h-full bg-slate-50 dark:bg-slate-800 flex items-center justify-center relative group/viewer">
                                        ...
                                        >
                                            <button slot="ar-button" className="absolute bottom-4 left-4 bg-amber-600 hover:bg-amber-700 text-white font-bold py-2 px-4 rounded-full shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] flex items-center gap-2 transition-transform active:scale-95 z-20">
                                                <Box size={18} />
                                                Vezi în AR
                                            </button>
                                        {/* @ts-ignore */}
                                        ...
                                        {!artworkUrl && (
                                            <div className="absolute inset-0 bg-slate-50 dark:bg-slate-800/80 backdrop-blur-[4px] z-30 flex flex-col items-center justify-center p-6 text-center">
                                                <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-md mb-4 text-amber-600">
                                                    <UploadCloud size={32} />
                                                </div>
                                        ...
                                        <div className="absolute bottom-4 right-4 z-20 hidden lg:block">
                                            <div className="bg-white/95 backdrop-blur-xl p-3 rounded-2xl border-2 border-amber-100 shadow-[0_8px_32px_rgba(0,0,0,0.12)] group/qr transition-all hover:scale-105 hover:border-amber-300">
                                                <div className="flex flex-col items-center gap-2">
                                                    ...
                                                    <div className="text-center">
                                                        <div className="text-[9px] font-black text-amber-600 uppercase tracking-widest">Vezi în AR</div>
                                ...
                                <div className="p-2 grid grid-cols-4 gap-2 border-t border-gray-100 bg-white">
                                    {GALLERY.map((src, i) => (
                                        <button
                                            ...
                                            className={`relative rounded-lg aspect-square overflow-hidden border-2 transition-all ${activeIndex === i ? "border-amber-600 shadow-md" : "border-transparent opacity-70 hover:opacity-100"}`}
                                        >
                        ...
                        <div className="bg-white rounded-2xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] border border-gray-200 dark:border-slate-800 px-4 mb-8">
                            ...
                            <AccordionStep stepNumber={2} title="Formă & Dimensiuni" summary={summaryStep2} isOpen={activeStep === 2} onClick={() => setActiveStep(2)}>
                                        ...
                                        <div className="mb-4">
                                            ...
                                            <div className="grid grid-cols-3 gap-2">
                                                <button
                                                    ...
                                                    className={`p-3 rounded-lg border-2 flex flex-col items-center gap-2 transition-all ${orientation === 'portrait' ? 'border-amber-600 bg-amber-50 text-amber-700' : 'border-slate-200 hover:border-slate-300'}`}
                                                >
                                                ...
                                                <button
                                                    ...
                                                    className={`p-3 rounded-lg border-2 flex flex-col items-center gap-2 transition-all ${orientation === 'landscape' ? 'border-amber-600 bg-amber-50 text-amber-700' : 'border-slate-200 hover:border-slate-300'}`}
                                                >
                                                ...
                                                <button
                                                    ...
                                                    className={`p-3 rounded-lg border-2 flex flex-col items-center gap-2 transition-all ${orientation === 'square' ? 'border-amber-600 bg-amber-50 text-amber-700' : 'border-slate-200 hover:border-slate-300'}`}
                                                >
                                ...
                                {input.frameType === "none" && upsellOpportunity && (
                                    <div
                                        className="mt-3 p-3 sm:p-4 bg-amber-50 border border-amber-200 rounded-lg cursor-pointer hover:bg-amber-100 transition-colors flex gap-3 items-center group relative"
                                        onClick={() => updateInput("quantity", upsellOpportunity.requiredQty)}
                                    >
                                        <TrendingUp className="text-amber-600 w-5 h-5 shrink-0" />
                                        <div className="flex-1">
                                            <p className="text-sm text-amber-900 font-bold">Reducere de Volum!</p>
                                        ...
                                        <div className="ml-auto flex flex-col items-end gap-2 shrink-0">
                                            <div className="flex items-center justify-center bg-white rounded-md px-2 py-0.5 shadow-sm border border-amber-100">
                                                <span className="text-xs font-bold text-amber-600">-{upsellOpportunity.discountPercent}%</span>
                                            </div>
                                            <button type="button" className="text-xs bg-amber-600 text-white px-3 py-1.5 rounded-md font-bold shadow-sm group-hover:bg-amber-700 transition-colors">
                                                Aplică
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div>
                                    ...
                                    {input.designOption === 'upload' && (
                                        <div className="space-y-3">
                                            ...
                                            <label className="flex flex-col items-center justify-center w-full h-32 px-4 bg-white border-2 border-gray-300 border-dashed rounded-md cursor-pointer hover:border-amber-400 transition-colors">
            ...
            {showArAutoLaunch && (
                <div className="fixed inset-0 z-[100] bg-black/90 backdrop-blur-md flex flex-col items-center justify-center p-6 text-center text-white">
                    <div className="w-24 h-24 bg-amber-600 rounded-full flex items-center justify-center shadow-[0_0_30px_rgba(16,185,129,0.4)] mb-8 animate-pulse">
                        <Box size={48} />
                    </div>
                    ...
                    <button
                        ...
                        className={`w-full max-w-xs py-4 font-black rounded-2xl shadow-xl transition-all flex items-center justify-center gap-3 text-lg ${!isArtLoaded ? 'bg-gray-600 cursor-not-allowed opacity-50' : 'bg-amber-600 hover:bg-amber-700 active:scale-95 text-white'}`}
                    >
                        {
