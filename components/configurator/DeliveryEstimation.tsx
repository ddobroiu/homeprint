...
export default function DeliveryEstimation({ county }: Props) {
    ...
    return (
        <div className="text-xs sm:text-sm flex items-center gap-1.5 bg-gradient-to-r from-amber-50 to-teal-50 border border-amber-300 rounded-lg px-2 py-1.5 shadow-sm h-full whitespace-nowrap">
