                    ...
                    <div>
                        ...
                        <div className="bg-white rounded-2xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] border border-gray-200 dark:border-slate-800 px-4 mb-8">
                            <AccordionStep stepNumber={1} title="Cantitate" summary={summaryStep1} isOpen={activeStep === 1} onClick={() => setActiveStep(1)}>
                                ...
                                {upsellOpportunity && (
                                    <div
                                        className="mt-3 p-3 sm:p-4 bg-amber-50 border border-amber-200 rounded-lg cursor-pointer hover:bg-amber-100 transition-colors flex gap-3 items-center group relative w-full"
                            ...
                            <AccordionStep stepNumber={2} title="Material și Finisaje" summary={summaryStep2} isOpen={activeStep === 2} onClick={() => setActiveStep(2)}>
                                ...
                                <div className="space-y-4 pt-4 border-t border-gray-100">
                                    <label className={`flex items-center gap-3 p-3 rounded-xl border cursor-pointer transition-all ${input.twoSided ? 'bg-amber-50 border-amber-200' : 'bg-slate-50 dark:bg-slate-800 border-gray-200 dark:border-slate-800 hover:bg-gray-100'}`}>
                                        <input type="checkbox" className="w-5 h-5 rounded border-gray-300 text-amber-600 focus:ring-amber-500" checked={input.twoSided} onChange={(e) => updateInput("twoSided", e.target.checked)} />
                                        <div>
                                    ...
                                    <label className={`flex items-center gap-3 p-3 rounded-xl border cursor-pointer transition-all ${input.roundedCorners ? 'bg-amber-50 border-amber-200' : 'bg-slate-50 dark:bg-slate-800 border-gray-200 dark:border-slate-800 hover:bg-gray-100'}`}>
                                        <input type="checkbox" className="w-5 h-5 rounded border-gray-300 text-amber-600 focus:ring-amber-500" checked={input.roundedCorners} onChange={(e) => updateInput("roundedCorners", e.target.checked)} />
                                        <div>
                                    ...
                                    <label className={`flex items-center gap-3 p-3 rounded-xl border cursor-pointer transition-all ${input.specialShape ? 'bg-amber-50 border-amber-200' : 'bg-slate-50 dark:bg-slate-800 border-gray-200 dark:border-slate-800 hover:bg-gray-100'}`}>
                                        <input type="checkbox" className="w-5 h-5 rounded border-gray-300 text-amber-600 focus:ring-amber-500" checked={input.specialShape} onChange={(e) => updateInput("specialShape", e.target.checked)} />
                                        <div>
                        ...
                        {activeProductTab === 'descriere' && (
                            <div className="prose dark:prose-invert max-w-none text-gray-700 dark:text-gray-300 text-sm sm:text-base">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div>
                                        <h3 className="text-xl font-bold text-amber-900 mb-3">Materiale Neconvenționale</h3>
                                    ...
                                    <div>
                                        <h3 className="text-xl font-bold text-amber-900 mb-3">Finisaje Optionale</h3>
