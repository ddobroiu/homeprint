                                        ...
                                        <div className="grid grid-cols-3 gap-2">
                                            {FLYER_CONSTANTS.SIZES.map((s: any) => (
                                                <button
                                                    ...
                                                    className={`py-2 text-xs font-bold border-2 rounded-lg transition-all ${sizeKey === s.key ? 'border-slate-950 bg-amber-50 text-amber-500' : 'border-gray-300 bg-white hover:border-gray-400'}`}
                                                >
                                                    {s.label}
                                                </button>
                                            ))}
                                        ...
                                        <div className="grid grid-cols-1 gap-2">
                                            {FLYER_CONSTANTS.PAPER_WEIGHTS.map((p: any) => (
                                                <button
                                                    ...
                                                    className={`py-2 px-3 text-xs font-bold border-2 rounded-lg transition-all ${paperWeightKey === p.key ? 'border-slate-950 bg-amber-50 text-amber-500' : 'border-gray-300 bg-white hover:border-gray-400'}`}
                                                >
                                                    {p.label}
                                                </button>
                                            ))}
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="grid grid-cols-2 gap-2">
                                            <button onClick={() => setTwoSided(false)} className={`py-3 rounded-lg border-2 text-sm font-bold ${!twoSided ? 'border-slate-950 bg-amber-50 text-amber-500' : 'border-gray-300 bg-white hover:border-gray-400'}`}>Față</button>
                                            <button onClick={() => setTwoSided(true)} className={`py-3 rounded-lg border-2 text-sm font-bold ${twoSided ? 'border-slate-950 bg-amber-50 text-amber-500' : 'border-gray-300 bg-white hover:border-gray-400'}`}>Față-Verso</button>
                                        </div>
                                    </div>
                                </div>
