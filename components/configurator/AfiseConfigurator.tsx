    ...
    return (
        <main className="bg-slate-50 dark:bg-slate-800 min-h-screen">
            <ProductJsonLd
                ...
                url={typeof window !== 'undefined' ? window.location.href : "https://www.HomePrint.ro/configurator/afise"}
            />
                            ...
                            <AccordionStep stepNumber={1} title="Dimensiune & Tiraj" summary={summaryStep1} isOpen={activeStep === 1} onClick={() => setActiveStep(1)}>
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <select value={size} onChange={(e) => setSize(e.target.value)} className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500">
                                    ...
                                    {upsellOpportunity && (
                                        <div
                                            className="mt-3 p-3 sm:p-4 bg-amber-50 border border-amber-200 rounded-lg cursor-pointer hover:bg-amber-100 transition-colors flex gap-3 items-center group relative md:col-span-2"
