                                    ...
                                    <div>
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                            <button
                                                ...
                                                className={`p-3 border-2 rounded-xl text-left transition-all ${input.print_type === "print_cut" ? "border-amber-600 bg-amber-50" : "border-gray-200 dark:border-slate-800 hover:border-amber-200"}`}
                                            >
                                            ...
                                            <button
                                                ...
                                                className={`p-3 border-2 rounded-xl text-left transition-all ${input.print_type === "print_only" ? "border-amber-600 bg-amber-50" : "border-gray-200 dark:border-slate-800 hover:border-amber-200"}`}
                                            >
                                                <p className="font-bold text-slate-900 dark:text-white text-sm">Doar Print</p>
                                                <p className="text-xs text-gray-500 text-amber-600 font-medium">Reducere -20%</p>
                                            </button>
                                        </div>
                                    </div>
