            ...
            <div className="container mx-auto px-4 py-8 lg:py-12">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div>
                        <div className="relative aspect-[3/4] bg-gray-100 rounded-2xl overflow-hidden shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] border border-gray-100 mb-6">
                            ...
                            <div className="absolute top-4 left-4">
                                <span className="bg-amber-600 text-white px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wide">
                                    {product.program}
                                </span>
                            </div>
                        </div>
                        <div className="bg-amber-50 p-6 rounded-2xl border border-amber-100 flex flex-col items-center text-center">
                            <MessageCircle size={32} className="text-amber-600 mb-3" />
                    ...
                    ${selectedSize === size.id
                                                ? "border-slate-950 bg-amber-50 ring-1 ring-slate-950"
                                                : "border-gray-200 dark:border-slate-800 hover:border-amber-300 hover:bg-slate-50 dark:bg-slate-800"}`}
                                    >
                                        <div>
                                            <div className={`font-bold ${selectedSize === size.id ? "text-amber-500" : "text-slate-900 dark:text-white"}`}>
                                                {size.label}
                                            </div>
                        ...
                        <div className="bg-white border-t border-gray-100 pt-6">
                            ...
                            <div className="flex flex-col gap-3">
                                <button
                                    ...
                                    className="w-full py-4 bg-amber-600 hover:bg-amber-700 text-white font-bold rounded-xl text-lg shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] shadow-slate-950/20 transition-all active:scale-[0.98] flex items-center justify-center gap-2"
                                >
