    ...
    return (
        <button
            ...
            className={`w-full text-left p-4 rounded-xl border-2 transition-all duration-200 ${active
                ? "border-slate-950 bg-amber-50/50 ring-1 ring-slate-950 shadow-md"
                : "border-gray-200 dark:border-slate-800 bg-white hover:border-gray-300 hover:bg-slate-50 dark:bg-slate-800"
                }`}
        >
            <div className={`font-bold transition-colors ${active ? "text-amber-500" : "text-gray-800"}`}>{title}</div>
...
function TabButton({ active, onClick, children }: { active: boolean; onClick: () => void; children: React.ReactNode; }) {
    return <button type="button" onClick={onClick} className={`px-4 py-2 text-sm font-semibold transition-colors rounded-t-lg ${active ? "border-b-2 border-slate-950 text-slate-950 bg-amber-50" : "text-gray-500 hover:text-gray-800"}`}>{children}</button>;
}
                        ...
                        <div className="bg-white rounded-2xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] border border-gray-200 dark:border-slate-800 overflow-hidden">
                            ...
                            <div className="flex border-b border-gray-100 overflow-x-auto">
                                ...
                                <button
                                    ...
                                    className={`flex-1 py-3 min-w-20 text-sm font-medium flex items-center justify-center gap-2 transition-colors ${viewMode === 'shape' ? 'text-amber-600 bg-amber-50 border-b-2 border-amber-600' : 'text-gray-500 hover:bg-slate-50 dark:bg-slate-800'}`}
                                >
                                    <Ruler size={16} />
                                ...
                                <div className="p-2 grid grid-cols-4 gap-2 border-t border-gray-100">
                                    {galleryImages.map((src, i) => (
                                        <button
                                            ...
                                            className={`relative rounded-lg aspect-square overflow-hidden ${activeIndex === i && !artworkUrl ? "ring-2 ring-offset-2 ring-amber-500" : "hover:opacity-80"}`}
                                        >
                                            <Image 
                                                src={src} 
                                                alt="Miniatura" 
                    ...
                    <div className={`${renderOnlyConfigurator ? 'w-full' : 'px-4 sm:px-0 w-full'}`}>
                        ...
                        <div className="bg-white rounded-xl sm:rounded-2xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] border border-gray-200 dark:border-slate-800 px-3 sm:px-4">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            placeholder="200"
                                            className="w-full p-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none transition-all shadow-sm text-lg font-medium bg-white text-slate-900"
                                        />
                                    </div>
                                    <div>
                            ...
                            <AccordionStep stepNumber={2} title="Material & Finisaje" summary={summaryStep2} isOpen={activeStep === 2} onClick={() => setActiveStep(2)}>
                                {productKind === "mesh" ? (
                                    <>
                                        <div className="mb-4 p-3 sm:p-4 bg-amber-50/60 dark:bg-amber-950/25 border border-amber-200 dark:border-amber-800 rounded-lg">
                                    ...
                                    {productImage ? (
                                        <div className="p-4 bg-slate-50 dark:bg-slate-800 border border-slate-200 rounded-xl">
                                            <div className="flex items-center gap-4 mb-4">
                                                ...
                                                <div>
                                                    <span className="inline-block px-2 py-0.5 rounded bg-amber-100 text-amber-700 text-xs font-bold mb-1">MODEL SELECTAT</span>
                                            ...
                                            <div className="border-t border-slate-200 pt-3">
                                                ...
                                                <div className="flex gap-2">
                                                    <button
                                                        ...
                                                        className={`flex-1 py-2 px-3 rounded-lg border text-sm font-semibold transition-colors ${input.designOption === 'upload' ? 'bg-amber-600 text-white border-amber-600' : 'bg-white border-gray-300 text-gray-700 dark:text-gray-300 hover:bg-slate-50 dark:bg-slate-800'}`}
                                                    >
                                                        Încărcare Fișier
                                                    </button>
                                                    <button
                                                        onClick={() => { setArtworkUrl(null); updateInput("designOption", "text_only"); }}
                                                        className={`flex-1 py-2 px-3 rounded-lg border text-sm font-semibold transition-colors ${input.designOption === 'text_only' ? 'bg-amber-600 text-white border-amber-600' : 'bg-white border-gray-300 text-gray-700 dark:text-gray-300 hover:bg-slate-50 dark:bg-slate-800'}`}
                                                    >
                                                        Doar Text
                                                    </button>
                                                </div>
                                                ...
                                                <div className="mt-4 pt-4 border-t border-slate-200 animate-fade-in-up">
                                                    ...
                                                    {input.designOption === 'text_only' && (
                                                        <div className="space-y-3">
                                                            ...
                                                            <textarea className="w-full p-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none transition-all shadow-sm text-base min-h-24 text-gray-800 bg-white" rows={3} value={textDesign} onChange={e => setTextDesign(e.target.value)} placeholder="Ex: NOUL TEXT AICI..."></textarea>
                                                        </div>
                                                    )}
                                                </div>
                                            )}
                                        ...
                                        <>
                                            ...
                                            {input.designOption === 'text_only' && (
                                                <div className="space-y-3">
                                                    ...
                                                    <textarea className="w-full p-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none transition-all shadow-sm text-base min-h-24 text-gray-800 bg-white touch-manipulation" rows={3} value={textDesign} onChange={e => setTextDesign(e.target.value)} placeholder="ex: PROMOTIE, REDUCERI, etc."></textarea>
                                                </div>
                                            )}
                            ...
                            <>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 pb-6 border-b border-gray-200 dark:border-slate-800">
                                    <div className="flex items-start gap-4">
                                        <div className="shrink-0 w-12 h-12 rounded-xl bg-gradient-to-br from-amber-500 to-purple-600 flex items-center justify-center shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)]">
                                    ...
                                    <div className="flex items-start gap-4">
                                        <div className="shrink-0 w-12 h-12 rounded-xl bg-gradient-to-br from-amber-500 to-teal-600 flex items-center justify-center shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)]">
                                            <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div className="bg-amber-50 rounded-xl p-6 sm:p-8 border border-amber-100 flex flex-col md:flex-row items-center gap-6 justify-between mt-8">
                                    <div className="flex-1 text-center md:text-left">
                                        <h4 className="text-amber-900 text-xl font-black mb-2 flex items-center justify-center md:justify-start gap-3">
                                    ...
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="shrink-0 flex items-center gap-3 px-8 py-4 bg-amber-600 text-white rounded-2xl font-black text-lg shadow-xl shadow-amber-500/20 hover:bg-amber-700 hover:-translate-y-1 transition-all uppercase tracking-wider"
                                    >
