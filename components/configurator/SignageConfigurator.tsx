                    ...
                    <div className="w-full lg:w-1/2 flex flex-col gap-6">
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <div className="flex justify-between items-center mb-1">
                                                                <span className="font-black text-slate-900 dark:text-white text-sm group-hover:text-amber-600 transition-colors">{sizeLabel}</span>
                                                                {selectedVariantIndex === vIndex && <Check size={16} className="text-amber-500" />}
                                                            </div>
                                        ...
                                        {DIMENSIONS.map((dim) => (
                                            ...
                                            >
                                                <div className="flex justify-between items-center mb-1">
                                                    ...
                                                    {selectedDim.value === dim.value && <Check size={16} className="text-amber-500" />}
                                                </div>
                                                {dim.multiplier > 1 ? (
                        ...
                        <div className="bg-white/80 backdrop-blur-xl rounded-3xl p-6 shadow-2xl border border-white/20 flex flex-col sm:flex-row items-center justify-between gap-6 sticky bottom-4 z-40">
                            ...
                            <button
                                ...
                                className="w-full sm:w-auto px-10 py-5 bg-amber-500 hover:bg-amber-600 text-white font-black rounded-2xl shadow-lg shadow-amber-500/30 hover:shadow-amber-500/50 hover:-translate-y-1 transition-all flex items-center justify-center gap-3 text-lg"
                            >
