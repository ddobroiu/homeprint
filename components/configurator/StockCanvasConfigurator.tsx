            ...
            <div className={`w-full max-w-full box-border ${renderOnlyConfigurator ? '' : 'container mx-auto px-4 py-4'}`}>
                {!renderOnlyConfigurator && (
                    <nav className="flex items-center gap-2 text-sm text-gray-500 mb-6">
                        ...
                        <Link href="/configurator/canvas" className="hover:text-amber-600">Shop / Canvas</Link>
                        <ChevronRight size={14} />
                        ...
                        <div className="pb-4 border-b border-gray-100">
                            <div className="flex border-b border-gray-100 bg-slate-50 dark:bg-slate-800/50">
                                <button
                                    ...
                                    className={`flex-1 py-3 text-sm font-bold flex items-center justify-center gap-2 transition-colors ${viewMode === 'gallery' ? 'text-amber-600 bg-white border-b-2 border-amber-600 shadow-sm' : 'text-gray-500 hover:text-gray-700 dark:text-gray-300'}`}
                                >
                                    <ImageIcon size={18} /> Foto
                                </button>
                                <button
                                    onClick={() => setViewMode('3d')}
                                    className={`flex-1 py-3 text-sm font-bold flex items-center justify-center gap-2 transition-colors ${viewMode === '3d' ? 'text-amber-600 bg-white border-b-2 border-amber-600 shadow-sm' : 'text-gray-500 hover:text-gray-700 dark:text-gray-300'}`}
                                >
                                    ...
                                    <div className="w-full h-full bg-slate-50 dark:bg-slate-800 flex items-center justify-center relative group/viewer">
                                        ...
                                        >
                                            <button
                                                ...
                                                className={`absolute bottom-4 left-4 font-bold py-2 px-4 rounded-full shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] flex items-center gap-2 transition-transform active:scale-95 z-20 ${!isTextureLoaded ? 'bg-gray-400 cursor-not-allowed opacity-70 text-gray-100' : 'bg-amber-600 hover:bg-amber-700 text-white'}`}
                                            >
                        ...
                        {!renderOnlyConfigurator && (
                            <header className="mb-6">
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    <span className="text-xs text-amber-600 font-bold flex items-center gap-1 bg-amber-50 px-2 py-1 rounded">
                        ...
                        <div className="bg-white rounded-2xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] border border-gray-200 dark:border-slate-800 p-6 mb-8 space-y-8">
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                {selectedDimension === dim && (
                                                    <div className="absolute -top-2 -right-2 bg-amber-600 text-white rounded-full p-0.5 shadow-sm">
                                                        <Check size={12} />
                                                    </div>
                                                )}
                                            </button>
                            ...
                            <div className="space-y-4 pt-4">
                                <button
                                    ...
                                    className="w-full py-4 text-lg font-bold bg-amber-600 text-white rounded-xl shadow-xl hover:bg-amber-700 transition-all flex items-center justify-center gap-2 active:scale-95"
                                >
