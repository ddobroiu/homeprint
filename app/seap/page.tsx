...
export const metadata: Metadata = {
    ...
    keywords: ["SEAP", "SICAP", "achizitii publice", "homeprint seap", "plata trezorerie", "e-factura", "catalog seap", "bannere seap", "semnalistica institutii"],
};
...
const SEAPFeatures = [
    ...
    },
    {
        ...
        description: "Un specialist HomePrint vă stă la dispoziție pentru a vă ajuta cu specificațiile tehnice și configurarea pachetelor.",
        icon: MessageSquare,
        color: "text-teal-600",
        bg: "bg-teal-50"
    }
                            ...
                            <div className="space-y-8 relative z-10">
                                <div className="flex gap-6">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-400">Alegeți produsele de pe HomePrint.ro sau solicitați o ofertă personalizată prin email la <span className="text-green-400 font-bold">contact@HomePrint.ro</span>.</p>
                                    </div>
                                </div>
                                <div className="flex gap-6">
                    ...
                    <div id="contact-seap" className="lg:col-span-1">
                        <div className="sticky top-32 p-10 bg-white rounded-[2.5rem] border border-slate-200 shadow-xl shadow-slate-200/50">
                            ...
                            <div className="space-y-6">
                                ...
                                <a href="mailto:contact@HomePrint.ro" className="flex items-center gap-5 p-6 rounded-2xl bg-slate-50 border border-slate-100 hover:border-green-400 transition-all group">
                                    <div className="w-14 h-14 bg-white rounded-xl shadow-sm flex items-center justify-center text-amber-600 group-hover:scale-110 transition-transform">
                                        <Mail className="w-7 h-7" />
                                    </div>
                                    <div>
                                        <span className="block text-xs font-bold text-slate-400 uppercase tracking-widest mb-1">Email SEAP</span>
                                        <span className="text-xl font-black text-slate-900 tracking-tight">contact@HomePrint.ro</span>
                                    </div>
                                </a>

                                <a href="https://wa.me/40750473111" className="flex items-center gap-5 p-6 rounded-2xl bg-amber-50 border border-amber-100 hover:border-amber-500 transition-all group">
                                    <div className="w-14 h-14 bg-white rounded-xl shadow-sm flex items-center justify-center text-amber-600 group-hover:scale-110 transition-transform">
                                        <MessageSquare className="w-7 h-7" />
                                    </div>
                                    <div>
                                        <span className="block text-xs font-bold text-amber-600/60 uppercase tracking-widest mb-1">WhatsApp de Urgență</span>
            ...
            <section className="py-32 bg-white text-center">
                <div className="container mx-auto px-4 max-w-4xl">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-6">
                        <a href="mailto:contact@HomePrint.ro" className="px-12 py-6 bg-slate-900 text-white rounded-2xl font-black text-xl hover:bg-slate-800 transition-all shadow-2xl shadow-slate-900/20 uppercase tracking-widest">
                            Trimite Email SEAP
                        </a>
