        ...
        <form method="post" action="/api/admin/login" className="space-y-4">
          <div>
            ...
            <input
              type="password"
              name="password"
              className="w-full rounded-md border border-slate-200 bg-slate-50 px-3 py-2 outline-none focus:border-amber-400"
          ...
          <button
            type="submit"
            className="w-full rounded-md bg-amber-600 hover:bg-amber-500 transition px-3 py-2 font-semibold text-white"
          >
            Intră în panou
          </button>
        </form>
