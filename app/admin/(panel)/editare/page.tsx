                ...
                <div className="lg:col-span-4 space-y-6">
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
                        ...
                        <div className="space-y-5">
                            ...
                            <div className="bg-slate-50 p-4 border border-slate-100 rounded-xl space-y-4 mb-2">
                                <div>
                                    ...
                                    <input 
                                        ...
                                        className="w-full bg-white border border-slate-200 rounded-lg px-3 py-2 text-sm text-slate-900 font-bold focus:ring-2 focus:ring-amber-500 outline-none placeholder-slate-300" 
                                        value={orderName} 
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <select 
                                            className="w-full bg-white border border-slate-200 rounded-lg px-3 py-2 text-sm text-slate-900 font-bold focus:ring-2 focus:ring-amber-500 outline-none"
                            ...
                            <div>
                                ...
                                <label className="flex flex-col items-center justify-center w-full h-24 border-2 border-dashed border-amber-300 rounded-xl cursor-pointer bg-amber-50 hover:bg-amber-100 transition-colors">
                                    <div className="flex flex-col items-center justify-center pt-2">
                                        <Upload className="w-6 h-6 text-amber-500 mb-1" />
                                        <p className="text-xs font-semibold text-amber-700">Apasă pentru upload</p>
                                        {imageName && <p className="text-[10px] text-amber-600 font-medium px-2 truncate max-w-full">{imageName}</p>}
                                    </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input 
                                        type="number" 
                                        className="w-full bg-slate-50 border border-slate-200 rounded-lg px-3 py-2 text-sm text-slate-900 font-bold focus:ring-2 focus:ring-amber-500 outline-none" 
                                        value={widthCm} 
                            ...
                            <div className="pt-4 border-t border-slate-100 flex items-center gap-2">
                                <input 
                                    ...
                                    className="w-4 h-4 text-amber-600 bg-slate-100 border-slate-300 rounded focus:ring-amber-500 cursor-pointer"
                                />
                            ...
                            {imageSrc && (
                                <div className="pt-4 border-t border-slate-100">
                                    <label className="block text-xs font-bold text-slate-700 mb-2 flex justify-between">
                                        ...
                                        <span className="text-amber-600">{(imgPos.scale * 100).toFixed(0)}%</span>
                                    </label>
                                    <input 
                                        type="range"
                                        min="0.1" 
                    ...
                    {(imageSrc || texts.length > 0) && (
                        <button
                            ...
                            className="w-full flex items-center justify-center gap-3 bg-slate-900 text-white font-black py-4 rounded-xl hover:bg-amber-600 shadow-xl shadow-slate-900/10 transition-all active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                    ...
                    <div className="bg-slate-100 rounded-2xl border border-slate-200 min-h-[500px] flex flex-col overflow-hidden relative shadow-inner">
                        <div className="flex flex-wrap items-center justify-between px-6 py-4 border-b border-slate-200 bg-white gap-4">
                            ...
                            <div className="flex gap-2 text-xs font-bold text-slate-600">
                                ...
                                <div className="bg-amber-50 text-amber-700 px-3 py-1 rounded-md border border-amber-200">
