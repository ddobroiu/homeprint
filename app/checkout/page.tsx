        ...
        <div className="grid lg:grid-cols-[minmax(0,2fr)_minmax(0,1.25fr)] gap-6 lg:gap-8">
            ...
            <header className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 sm:p-6 shadow-sm">
              <div>
                <h1 className="text-xl sm:text-2xl font-black text-black dark:text-white flex items-center gap-2">
                  Finalizare Comandă
                  <span className="inline-flex items-center justify-center rounded-full bg-amber-600 text-white text-xs font-bold px-3 py-1 shadow-sm">
          ...
          <aside className="lg:col-span-1 lg:sticky lg:top-6 space-y-4 lg:space-y-6">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 overflow-hidden">
              <div className="bg-gradient-to-r from-teal-600 to-amber-600 px-4 sm:px-5 py-3">
                ...
                <div className="grid gap-3">
                  {!isCardDisabled && (
                    <label
                      className={`flex items-center gap-3 rounded-xl border-2 p-3 cursor-pointer transition ${paymentMethod === "card"
                        ? "border-amber-600 bg-amber-50 dark:bg-amber-950 ring-2 ring-amber-200 dark:ring-amber-800"
                        : "border-slate-300 dark:border-slate-700 hover:border-amber-400 hover:bg-slate-50/60 dark:hover:bg-slate-900/60"
                        }`}
                    >
                      <input
                        type="radio"
                        ...
                        className="hidden"
                      />
                      <div className={`flex-shrink-0 flex items-center justify-center h-9 w-9 rounded-full border-2 ${paymentMethod === "card" ? "bg-amber-600 border-amber-600" : "bg-white dark:bg-slate-900 border-amber-400"}`}>
                        <CreditCard className={`h-5 w-5 ${paymentMethod === "card" ? "text-white" : "text-amber-600"}`} />
                      </div>
                  ...
                  >
                    <input
                      ...
                      className="hidden"
                    />
                    <div className={`flex-shrink-0 flex items-center justify-center h-9 w-9 rounded-full border-2 ${paymentMethod === "bank_transfer" ? "bg-amber-600 border-amber-600" : "bg-white dark:bg-slate-900 border-amber-400"}`}>
                      <Banknote className={`h-5 w-5 ${paymentMethod === "bank_transfer" ? "text-white" : "text-amber-600"}`} />
                    </div>
                    <div className="flex-1">
                      <p className="font-semibold text-slate-900 dark:text-white">
                  ...
                  {paymentMethod === "bank_transfer" && (
                    <div className="rounded-xl border border-amber-200 dark:border-amber-800 bg-amber-50/80 dark:bg-amber-950/40 p-4 text-sm space-y-2">
                      ...
                      <div className="flex justify-between gap-3">
                        ...
                        <span className="text-amber-700 dark:text-amber-400 font-bold select-all text-right">{BANK_TRANSFER_IBAN}</span>
                      </div>
                      <div className="flex justify-between gap-3">
                  ...
                  {!isRambursDisabled && (
                    ...
                    >
                      <input
                        ...
                        className="hidden"
                      />
                      <div className={`flex-shrink-0 flex items-center justify-center h-9 w-9 rounded-full border-2 ${paymentMethod === "cash_on_delivery" ? "bg-amber-600 border-amber-600" : "bg-white dark:bg-slate-900 border-amber-400"}`}>
                        <Truck className={`h-5 w-5 ${paymentMethod === "cash_on_delivery" ? "text-white" : "text-amber-600"}`} />
                      </div>
                      <div className="flex-1">
                        <p className="font-semibold text-slate-900 dark:text-white">
                          Ramburs la curier
                  ...
                  <label className="flex items-start gap-2 text-xs text-slate-700 dark:text-slate-300">
                    ...
                    <span>
                      ...
                      <Link
                        ...
                        className="text-amber-600 dark:text-amber-400 font-semibold underline-offset-2 hover:underline"
                        target="_blank"
                      >
  ...
  if (placing) {
    return (
      <button
        type="button"
        disabled
        className="inline-flex w-full items-center justify-center rounded-xl border border-transparent bg-amber-500 px-4 py-3 text-sm font-semibold text-white shadow-lg shadow-amber-500/30 transition"
      >
        <svg
