      ...
      try {
        ...
        if (resend) {
          await resend.emails.send({
            from: 'HomePrint System <system@HomePrint.ro>',
            to: process.env.ADMIN_EMAIL,
            subject: `📊 Raport zilnic marketing HomePrint.ro - ${stats.sent} emailuri trimise`,
            html: `
            ...
            <p><small>Sistem automat HomePrint.ro</small></p>
            `
          });
        }
      } catch (emailError) {
