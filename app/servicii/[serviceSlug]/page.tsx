...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    ...
    const description = `${service.description} Alege calitatea HomePrint pentru finisaje de înaltă precizie: ${service.name.toLowerCase()}. Producător direct, rezultate impecabile.`;

    return {
        title,
        description,
        alternates: {
            canonical: `https://www.homeprint.ro/servicii/${serviceSlug}`
        },
        openGraph: {
            title,
            description,
