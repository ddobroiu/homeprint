...
export const metadata = {
    ...
    keywords: ['noutati print', 'articole seo', 'dimensiuni hartie', 'ghid print a4', 'homeprint noutati'],
    alternates: {
        canonical: '/noutati',
    },
    openGraph: {
        ...
        type: "website",
        images: ["/logo-homeprint_1.png.webp"],
    }
};
...
export default async function NoutatiPage() {
    ...
    // Filter by source and by 'noutati' tag (to keep it clean) or just show all relevant to homeprint
        ...
        <main className="min-h-screen pt-32 pb-20 bg-slate-50">
            ...
            <section className="container mx-auto px-6 mb-16">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <h1 className="text-4xl md:text-6xl font-black text-slate-900 mb-6 tracking-tight">
                        Centrul de <span className="text-amber-600">Cunoaștere</span> HomePrint
                    </h1>
                        ...
                        >
                            ...
                            <Link href={`/noutati/${post.slug}`} className="block relative h-64 overflow-hidden">
                                {post.hero ? (
                                    ...
                                    <div className="w-full h-full bg-gradient-to-br from-slate-900 via-slate-800 to-amber-900 flex items-center justify-center p-8 text-center relative overflow-hidden">
                                        {/* Abstract Decorations */}
                                        <div className="absolute top-0 right-0 w-32 h-32 bg-amber-500/10 rounded-full -translate-y-1/2 translate-x-1/2 blur-3xl"></div>
                            ...
                            <div className="p-8 flex flex-col flex-grow">
                                ...
                                <h2 className="text-xl font-bold text-slate-900 mb-4 group-hover:text-amber-600 transition-colors leading-tight">
                                ...
                                <div className="mt-auto pt-6 border-t border-slate-50 flex items-center justify-between">
                                    <Link
                                        ...
                                        className="inline-flex items-center gap-2 text-sm font-bold text-slate-900 hover:text-amber-600 transition-colors group/btn"
                                    >
                                        Vezi tot articolul
            ...
            <section className="container mx-auto px-6 mt-20 !max-w-5xl">
                <div className="bg-slate-900 rounded-[3rem] p-12 md:p-16 text-center relative overflow-hidden shadow-2xl">
                    ...
                    <Link 
                        href="/contact" 
                        className="inline-flex items-center gap-3 bg-amber-500 hover:bg-amber-400 text-white font-black px-10 py-5 rounded-2xl transition-all hover:scale-105 active:scale-95 shadow-xl shadow-amber-500/20 relative z-10"
                    >
                        Contactează-ne acum
                        <ArrowRight size={20} />
                    </Link>
