...
export default async function HanoracePage({ searchParams }: Props) {
    ...
    const url = `${process.env.NEXT_PUBLIC_SITE_URL || "https://www.HomePrint.ro"}/hanorace`;
                ...
                <div className="container mx-auto px-4 max-w-5xl">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                            La <strong className="text-amber-600">HomePrint.ro</strong>, realizăm hanorace Profesional groase (peste 300g), foarte călduroase și confortabile, printate digital folosind utilaje DTF de mare viteză și precizie!
                        </p>
                    </div>
                </div>
            </section>
