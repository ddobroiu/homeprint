...
export default function NotFound() {
    return (
        <main className="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center p-4 pt-32 pb-20 overflow-hidden relative">
            ...
            <div className="absolute top-1/4 -right-20 w-96 h-96 bg-amber-600/10 rounded-full blur-[120px] animate-pulse"></div>
            ...
            <div className="max-w-4xl w-full relative z-10 text-center">
                ...
                <div className="mt-12">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 px-4">
                        <Link href="/configurator/banner" className="group bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200 dark:border-slate-800 hover:border-amber-500 transition-all hover:shadow-xl hover:-translate-y-1">
                            <Printer className="text-amber-600 mb-3 group-hover:scale-110 transition-transform" />
